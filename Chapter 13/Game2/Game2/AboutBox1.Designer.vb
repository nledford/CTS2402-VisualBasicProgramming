...
Partial Class AboutBox1
    ...
    Private Sub InitializeComponent()
        ...
        Me.LabelProductName.Text = "Division Game"
        ...
        Me.LabelVersion.Text = "Version 2.1.1.2"
        ...
        Me.LabelCopyright.Text = "Public Domain"
        ...
        Me.LabelCompanyName.Text = "Poor College Student"
        ...
        Me.TextBoxDescription.Text = "Click Start.  A random number will be given.  Divide the number by 3 to get a rem" & _
    "inder.  Drag the number to the column with the correct remainder."
        '
        'OKButton
        '
