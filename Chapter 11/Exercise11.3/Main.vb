...
Public Class Main
    Dim IsDirtyBoolean As Boolean = True

    Private Sub Main_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim ResponseDialogResult As DialogResult
        Dim MessageString As String = "Your list of bagels has changed.  Would you like to save your changes?"
    ...
    Private Sub Main_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            Dim BagelsStreamReader As StreamReader =
                New StreamReader("bagels.txt")
            Do Until BagelsStreamReader.Peek = -1
                BagelTypeString = BagelsStreamReader.ReadLine()
                comboBoxBagels.Items.Add(BagelTypeString)
            Loop
            BagelsStreamReader.Close()
        Catch ex As Exception
            ResponseDialogResult = MessageBox.Show("Create A New File?", "File Not Found", MessageBoxButtons.YesNo, _
    ...
    Private Sub ButtonSaveList_Click(sender As System.Object, e As System.EventArgs) Handles ButtonSaveList.Click
        Dim NumberItemsInteger As Integer
        Dim BagelsStreamWriter As StreamWriter =
            New StreamWriter("bagels.txt")
        NumberItemsInteger = comboBoxBagels.Items.Count - 1
        For IndexInteger As Integer = 0 To NumberItemsInteger
            BagelsStreamWriter.WriteLine(comboBoxBagels.Items(IndexInteger))
        Next IndexInteger
        BagelsStreamWriter.Close()
